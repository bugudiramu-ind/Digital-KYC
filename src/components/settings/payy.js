...
export default class Payy extends Component {
    ...
    constructor(props) {
        ...
        this.state = { checked: false, payment_amount: 0, amount: 25000, 
            redirect:false 
    ...
    paymentHandler(e) {
        ...
        let options = {
            ...
            "handler": function (response) {
                ...
                axios(JSONData.fs_api_url+'/update_payment', {
                    method: 'POST',
                    ...
                    <div className="row justify-content-center">
                        <div id="payForm">
                            ...
                            <form>
                                ...
                                <input name="amount" value="INR 25,000" className="textInput" type="text" placeholder="" size="30" disabled />

                                <label id="name">Validity</label>
                                <input name="validity" value="30 days" className="textInput" type="text" placeholder="" size="30" disabled />

                                <button id="payButton" onClick={this.paymentHandler}>Pay with Razorpay</button>
                            </form>
