...
class Register extends Component {
    ...
    onSignUp = event => {
        ...
        // console.log(data);
        axios(JSONData.fs_api_url+'/register_customer', {
            method: 'POST',
            ...
            if(res.status === 200){
                this.setState ({mess1: res.data.message, mess2: "Please check your mail for the Activation Link", redirect: true});
            }
            else {
                            ...
                            <form onSubmit={this.onSignUp} >
                                <div className="row">
                                    <div id="space">
                                        ...
                                        <input name="fname" onChange={this.handleFirstnameChange} className="textInputforName" type="text" placeholder="" size="50" required />
                                    </div>

                                    <div id="space">
                                        <label id="name">Last Name</label>
                                        <input name="lname" onChange={this.handleLastnameChange} className="textInputforName" type="text" placeholder="" size="50" required />
                                    </div>
                                </div>


                                <label id="name">Work Email</label>
                                <input name="email" onChange={this.handleEmailChange} className="textInput" type="text" placeholder="" size="50" required />

                                <div id="pass" className="row">
                                    <label>Set Password</label>
                                </div>
                                <div>
                                    <input name="password" onChange={this.handlePasswordChange} className="textInput" type="password" placeholder="" id="password-field" size="50" required />
                                ...
                                <input name="company" onChange={this.handleCompanyChange} className="textInput" type="text" placeholder="" size="50" required />

                                <label id="name">Company Type</label>
                                <select name="companyType" onChange={this.handleCompanyTypeChange} className="textInput" required>
                                    <option selected disabled>- Please Select -</option>
                                    <option value="In-house Developer">In-house Developer</option>
                                    <option value="Start-up">Start-up</option>
                                    <option value="Software Development Firm">Software Development Firm</option>
                                    <option value="Freelancer">Freelancer</option>
                                    <option value="Other">Other</option>
                                </select>

                                <label id="name">Industry</label>
                                <select name="industry" onChange={this.handleIndustryChange} className="textInput" required>
                                    <option selected disabled>- Please Select -</option>
                                ...
                                <label id="name">Expected number of Transactions per month</label>
                                <select name="noOfTrans" onChange={this.handleNoOfTransChange} className="textInput" required>
                                    <option selected disabled>- Please Select -</option>
                                ...
                                <input name="regType" value="Express" onChange={this.handleRegTypeChange} className="textInput" type="text" placeholder="" size="50" disabled />

                                <div id="recaptcha" className="g-recaptcha" data-sitekey="6Ld4Jh8TAAAAAD2tURa21kTFwMkKoyJCqaXb0uoK"></div>
