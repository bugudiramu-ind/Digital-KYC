...
export default class Sample extends Component {
  ...
  order = (e) => {
    e.preventDefault();
    axios(process.env.REACT_APP_FS_API_URL + 'get_orderid', {
      method: 'POST',
            ...
            <div id='settingsBody' className='container row'>
              <div id='plansWhite'>
                <div id='plansRed' className='row justify-content-center'>
                  <p>
                    Your {this.state.mess} expires in {this.state.Rdays} days.
                    To continue using IN-D FS, please click proceed to payment
                    in the plan below.
                  </p>
                </div>
                ...
                <div
                  id='onboardFull'
                  className='container fullscreen justify-content-center align-items-center'
                >
                  <p className='font-weight-bold' id='title1'>
                    Plans and Pricing
                  </p>
                  <div className='big-container'>
                    <div className='small-container'>
                      ...
                      <div className='data'>
                        <p>
                          &#10003; <b>30-Day Free Trail</b> upto 5000 documents
                        </p>
