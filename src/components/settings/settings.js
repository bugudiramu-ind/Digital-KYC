...
class Settings extends Component {
    ...
    display() {
        ...
        axios(JSONData.fs_api_url + '/display_users', {
            method: 'POST',
    ...
    add = () => {
        ...
        axios(JSONData.fs_api_url + '/add_user', {
            method: 'POST',
                        ...
                        <div id="settingsHead">
                            ...
                            <div id="upperNavContainer" className="container">
                                <div id="upperNavBar" className="row justify-content-left">
                                    <Link to="/Settings"><a href='#/' id="hov" className="activeNav">
                                        Users
                                    </a> </Link>

                                    <Link to="/Plans_Billing"><a href='#/' id="hov" className="">
                                        Plans and Billing
                                    </a> </Link>
